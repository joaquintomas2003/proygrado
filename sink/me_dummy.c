...
volatile export __mem40 uint32_t latch = 0xFF;         /* wake/trigger latch (template style) */
volatile export __mem40 uint32_t timers = 0;          /* single-timer guard */
volatile export __mem40 uint32_t dummy_counter = 0;   /* visible counter to confirm ME runs */
